...
| <!-- -->                                              | A comment, what is wrote in the center can't be seen in the actual browser, but can be seen when you open the code.           |
| <div style="text-align: center;"><div>                | Should be used often around images to help words stay together and not break off in the middle by the bottom of the picture.  |
| <img src="(link)" width="number" height="number">     | Is where you put the link to an image.  width and height are attributes which determine the width and height in pixels. |
